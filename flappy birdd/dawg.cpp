...
//                scoredFlags[pipeCount] = false; // Reset scoring flag for top pipe
//                pipeCount++;
//
//                pipes[pipeCount].setTexture(pipeTexture);
//                pipes[pipeCount].setPosition(1000.0f, randomY);
//                pipes[pipeCount].setScale(0.5f, -2.0f);
//                scoredFlags[pipeCount] = false; // Reset scoring flag for bottom pipe
//                pipeCount++;
//            }
//
...
//
//            for (int i = 0; i < pipeCount; i++) {
//                if (!scoredFlags[i] && pipes[i].getPosition().x + 52.0f < flappy.getPosition().x) {
//                    if (i % 2 == 0) {
//                        score++;
//                        cout << "Score: " << score << endl;
//                    }
//                    scoredFlags[i] = true; // Mark pipe as scored
//                }
//            }
//
//            int newPipeCount = 0;
...
//                    scoredFlags[newPipeCount] = scoredFlags[i]; // Preserve flags
//                    newPipeCount++;
//                }
//            }
